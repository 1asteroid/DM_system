...
const TextQualityAnalysis = ({ topicId, topicTitle }) => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-lg font-bold text-gray-900 mb-2">Matn Sifati Tahlili</h2>
        <p className="text-sm text-gray-600">Mavzu: <span className="font-semibold">{topicTitle}</span></p>
      </div>
        ...
        return (
          <div key={analysis.id} className={`p-6 border border-gray-200 rounded-lg ${getScoreBg(qualityScore)}`}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              <div>
                <h3 className="text-sm font-semibold text-gray-900 mb-4">Umumiy Ko'rsatkichlar</h3>
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">So'zlar soni:</span>
                    <span className="font-semibold text-gray-900">{wordCount}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">Noyob so'zlar:</span>
                    <span className="font-semibold text-gray-900">{uniqueWords}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">Gap soni:</span>
                    <span className="font-semibold text-gray-900">{sentenceCount}</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">Paragraf soni:</span>
              ...
              <div>
                <h3 className="text-sm font-semibold text-gray-900 mb-4">Tahlil Ko'rsatkichlari</h3>
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">O'rtacha gap uzunligi:</span>
                    <span className="font-semibold text-gray-900">{avgWPS} so'z</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">Lug'at boyligi:</span>
            ...
            <div className="bg-white p-4 rounded-lg border-t border-gray-200 mt-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs text-gray-600 mb-2">Umumiy Sifat Ballari</p>
